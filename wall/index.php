...
<div class="kword ui shape ">
	<div class="sides">
		<div class="k active side">微信添加微信号：<strong><?php echo $dianplu_wxh;?></strong> <br>发送<?php  echo $xuanzezu[0];?>+您想说的话即可上墙！</div>
...
<div class="mone" id="mone" onClick="viewOneHide();"><div class="leftside"><div class="part"><div class="pic"><img class="msgconimg" src="" width="100" height="100"></div><div class="username" style="color:#fff"><span style="color:#fff"></span></div></div></div><div class="rightside"><div class="rightmain"><div class="rconner"></div><span class="msgcon"></span></div></div></div>
 ...
 <div id="explan" onClick="viewExplan();" class="ui primary segment" >
    ...
    <center><div class="mabox">
        <?php 
            if($weibo){
                echo '<div class="pic"><center><a class="ui green label"><b style="font-size:2em;line-height: 1.7em;">微博:'.$weiboconf['nickname'].'</b></a></center><img src="'.$weiboconf['erweima'].'" width=362px height=362px;/></div>';
            }
            if($weixin){
                echo'<div class="pic"><center><a class="ui blue label"><b style="font-size:2em;line-height: 1.7em;">微信:'.$dianplu_wxh.'</b></a></center><img src="'.$weixinconf['erweima'].'" width=362px height=362px;/></div>';
            }
